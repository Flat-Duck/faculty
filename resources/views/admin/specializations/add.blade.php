...
<div class="page-body">
    <div class="container-xl">
        <div class="row row-cards">
            <div class="col-12">
                <form role="form" method="POST" action="{{ route('admin.specializations.store') }}"  enctype="multipart/form-data"  class="card">                
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-xl-6">
                                ...
                                <x-form.input  type="text" name="name" placeholder="إسم التخصص" />
