    ...
    <form class="card card-md" method="post" autocomplete="off">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" value="{{ old('username') }}" class="form-control @error('username') is-invalid @enderror" placeholder="{{ __('Enter Username') }}" required autofocus tabindex="1">
                @error('username')
            ...
            <span class="form-label-description">                        
                <a  href="{{ route('admin.forgot_password') }}" tabindex="5">{{ __('Forgot Password?') }}</a>
            </span>
            @endif
