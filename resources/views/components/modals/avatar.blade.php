        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="dropzone dz-clickable" action="./" id="dropzone-custom">
            ...
            <div class="modal-footer">
                <form  action="./profile/avatar" method="POST" autocomplete="off" novalidate="">
                    @csrf
              <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">حفظ</button>
              <input type="file" name="avatar" multiple="multiple" class="dz-hidden-input" tabindex="-1" style="visibility: hidden; position: absolute; top: 0px; left: 0px; height: 0px; width: 0px;">   
            </form>
            </div>
          </div>
        </div>
